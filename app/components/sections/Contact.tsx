...
export default function Contact() {
    ...
    return (
        <section id="contact" className="py-8 sm:py-12 px-4">
            <div className="max-w-2xl w-full mx-auto p-4 sm:p-6 md:p-8 bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-gray-200">
                <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center mb-6 sm:mb-8 text-gray-800">Contact</h2>
